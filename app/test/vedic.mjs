 ...
 *  2) РЕАЛЬНАЯ джйотиш-программа, которой пользуется астролог: карта
 *     12.03.1998 18:10 (+2), 54°13′N 28°30′E. Её значения приведены в
...
console.log('=== карта 12.03.1998 18:10 +2 (эталон — джйотиш-программа астролога) ===');
{
  const jd = eph.toJD(new Date(Date.UTC(1998, 2, 12, 16, 10)));   // 18:10 +2 → 16:10 UT
  // Значения с экрана программы (градус в знаке):
  const ref = {
