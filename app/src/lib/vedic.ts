...
// СВЕРЕНО С АСТРОЛОГОМ 13.08.2026: он прислал свою таблицу «друзья/нейтральные/
// враги» — все 42 клетки сошлись с этой. Таблица перенесена в тест
// `app/test/vedicmath.mjs` как эталон: правки сверять с ней, не «по памяти».
