 ...
 *
 * Запуск:  node astra-engine/tools/golden.mjs   (пишет в astra-engine/golden/)
 */
...
const meta = {
  ...
  mode: E.mode,
  objects: OBJECTS,
  note: 'Порт обязан выдать те же значения. Допуски — в astra-engine/README.md.',
};
