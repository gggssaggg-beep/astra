...
export interface Settings {
  ...
  vedicSimple?: boolean;
  /** избранные транзиты джйотиша: пары «Граха|Знак» (★ на плашке дня) */
  favTransits?: string[];
...
export interface JournalNote {
  ...
  // ОТКУДА сделана заметка (просьба владелицы 2026-07-25): «Я+Пётр 13.06.25»,
  // «Пётр 20.06.2006» (натал — дата рождения), «Небо 13.06.25» (день на главной).
